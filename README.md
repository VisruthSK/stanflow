...
[![codecov](https://codecov.io/gh/VisruthSK/stanflow/branch/main/graph/badge.svg)](https://codecov.io/github/VisruthSK/stanflow?branch=main)
...
[![Ask
DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/VisruthSK/stanflow)
<!-- badges: end -->
...
`cmdstanr`) are all “`library()`d” as well, so we can proceed with our
